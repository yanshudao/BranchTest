...
public class MajorCourseOrgVO implements java.io.Serializable {
    ...
    private List<OrderResourceVO> resourceList;
    ...
    public List<OrderResourceVO> getResourceList() {
        return resourceList;
    }

    public void setResourceList(List<OrderResourceVO> resourceList) {
